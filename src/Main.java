        ...
        do {
            ...
            switch (choice) {
                ...
                case 2: {
                    ...
                    Doctor doctor = new Doctor(doctorId, doctorName, doctorAge, doctorGender, specialization, salary,
                            yearsOfExperience);
                    hospital.addDoctor(doctor);
                ...
                case 10: {
                    ...
                    boolean patientUpdated = hospital.updatePatientById(updatePatientId, newPatientName, newPatientAge,
                            newPatientGender, newPatientDisease, newPatientBloodType, newPatientMedicalHistory);
                    if (patientUpdated) {
                ...
                case 11: {
                    ...
                    boolean doctorUpdated = hospital.updateDoctorById(updateDoctorId, newDoctorName, newDoctorAge,
                            newDoctorGender, newDoctorSpecialization, newDoctorSalary, newDoctorYearsOfExperience);
                    if (doctorUpdated) {
